...
public class NBTEditor {
	...
	static {
		...
		try {
			...
			methodCache.put( "getTileEntity", getNMSClass( "CraftBlockState" ).getMethod( "getTileEntity" ) );
			methodCache.put( "setTileTag", getNMSClass( "TileEntity" ).getMethod( "a", getNMSClass( "NBTTagCompound" ) ) );
			methodCache.put( "updateTile", getNMSClass( "TileEntity" ).getMethod( "update" ) );
			methodCache.put( "udateState", getNMSClass( "CraftBlockState" ).getMethod( "update", boolean.class, boolean.class ) );
		} catch( Exception e ) {
			e.printStackTrace();
		}
...
//			for ( Object key : keys ) {
//				if ( notCompound == null ) return false;
...
//		try {
//			Object craftState = block.getState();
//			
//			Object tileEntity = getMethod( "getTileEntity" ).invoke( craftState );
//			
//			tileEntity = ( ( CraftWorld ) block.getWorld() ).getTileEntityAt( block.getX(), block.getY(), block.getZ() );
//			
//			Object tag = getMethod( "getTileTag" ).invoke( tileEntity, getNMSClass( "NBTTagCompound" ).newInstance() );
//			
//			setTag( tag, value, keys );
...
//			
//			getMethod( "updateTile" ).invoke( tileEntity );
//			
//			getMethod( "updateState" ).invoke( craftState, true, true );
//		} catch( Exception exception ) {
//			exception.printStackTrace();
//			return;
//		}
